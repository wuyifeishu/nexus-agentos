...
from agentos.guardrails.engine import GuardrailAction, GuardrailEngine
from agentos.guardrails.rules import build_default_rules
...
def run_file_ops_agent(scan_dir: str, auto_approve: bool = False):
    ...
    print("=" * 65)
    print("  Nexus AgentOS — Secure File Operations Agent")
    print(f"  Scan directory: {safe_base}")
    print("  Sandbox mode:   Process")
    ...
    summary_prompt = "Analyze this file scan report:\n\n"
    ...
    for f in all_findings:
        ...
        if f["code_injection"]:
            report_lines.append("  - Code injection detected")
